...
for (orth in 1:nrow(pathenv)) {
	if (!is.na(match(pathenv[orth,1], colnames(pathscores2))) & !is.na(match(pathenv[orth,2], colnames(envscores2)))) {
...
hist(kstable$DBS[kstable$DBS<50 & kstable$DBS>(-50)], breaks=seq((-50), 50, by=5), freq=F, xlim=c(-50,50), ylim=c(0,0.1), main="Score distribution for \nPathogenic-Environmental comparison", xlab="Delta-bitscore", ylab="Density", cex.main=1.5, cex.axis=1.3, cex.lab=1.3)
...
hist(kstable$DBS[kstable$DBS<50 & kstable$DBS>(-50)], breaks=seq((-50), 50, by=5), freq=F, xlim=c(-50,50), ylim=c(0,0.1), main="Score distribution for \nPathogenic-Rhizosphere comparison", xlab="Delta-bitscore", ylab="Density", cex.main=1.5, cex.axis=1.3, cex.lab=1.3)
lines(distdens, col="coral4", lwd=2)
dev.off()
...
hist(kstable$DBS[kstable$DBS<50 & kstable$DBS>(-50)], breaks=seq((-50), 50, by=5), freq=F, xlim=c(-50,50), ylim=c(0,0.1), main="Score distribution for \nRhizosphere-Environmental comparison", xlab="Delta-bitscore", ylab="Density", cex.main=1.5, cex.axis=1.3, cex.lab=1.3)
lines(distdens, col="coral4", lwd=2)
dev.off()
